...
if("TRUE" STREQUAL "TRUE")
  set(rospack_SOURCE_PREFIX /home/drocode/ros_catkin_ws/src/rospack)
  set(rospack_DEVEL_PREFIX /home/drocode/ros_catkin_ws/devel)
  set(rospack_INSTALL_PREFIX "")
  set(rospack_PREFIX ${rospack_DEVEL_PREFIX})
else()
  set(rospack_SOURCE_PREFIX "")
  set(rospack_DEVEL_PREFIX "")
  set(rospack_INSTALL_PREFIX /home/drocode/ros_catkin_ws/install)
...
if(NOT "/home/drocode/ros_catkin_ws/src/rospack/include;/usr/include " STREQUAL " ")
  set(rospack_INCLUDE_DIRS "")
  set(_include_dirs "/home/drocode/ros_catkin_ws/src/rospack/include;/usr/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rospack' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/drocode/ros_catkin_ws/src/rospack/${idir}'.  ${_report}")
    endif()
    _list_append_unique(rospack_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "rospack;/usr/lib/arm-linux-gnueabihf/libpython3.7m.so;/usr/lib/arm-linux-gnueabihf/libboost_filesystem.so;/usr/lib/arm-linux-gnueabihf/libboost_program_options.so;/usr/lib/arm-linux-gnueabihf/libboost_system.so;/usr/lib/arm-linux-gnueabihf/libtinyxml2.so")
